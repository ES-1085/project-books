...
book_genre %>% 
  select("title", "genre_1", "genre_2", "genre_3", "genre_4", "genre_5") %>% 
  pivot_longer(cols = !title, names_to = "order", values_to = "genre", values_drop_na = TRUE) %>% 
  mutate(genre_categories = pivot_longer(names_to = "order", values_to = "genre", values_drop_na = TRUE)) 
 # ggplot(x = "genre")+
  #geom_bar()
```
